...
public class MyShopItemTwoListViewAdapter extends BaseAdapter {

    private List<Integer> data;
    private LayoutInflater layoutInflater;
    private Context context;

    public MyShopItemTwoListViewAdapter(Context context,List<Integer> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.myshopitem2_list,null);
